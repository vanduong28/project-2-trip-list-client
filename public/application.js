...
/***/ (function(module, exports, __webpack_require__) {
	...
	var city = __webpack_require__(13);
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    ...
	    production: 'https://secure-lowlands-17816.herokuapp.com/'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var hideButtons = function hideButtons(event) {
	  $('.hide-on-start').hide();
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var hideInputFields = function hideInputFields(event) {
	  $('#city-input-fields').hide();
	  $('.view-cities-button').hide();
	  $('.new-city-button').hide();
	  $('.map-container').hide();
	...
	var addCity = function addCity(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.createCity(data).then(ui.createCitySuccess).catch(ui.createCityFailure);
	};

	var onGetCities = function onGetCities(event) {
	  event.preventDefault();
	  api.getCities().then(ui.getCitiesSuccess).catch(ui.getCitiesfailure);
	};

	var onDeleteCity = function onDeleteCity(event) {
	  event.preventDefault();
	  var cityId = $(this).data('id');
	  api.deleteCity(cityId).then(ui.deleteCitySuccess(cityId)).catch(ui.deleteCityFailure);
	};

	var onUpdateCity = function onUpdateCity(event) {
	  event.preventDefault();
	  var cityId = $(this).data('id');
	  // console.log('update info button clicked cityId is:', cityId)
	  var updateInfo = getFormFields(this);
	  // console.log('updated info:', updateInfo)
	  api.updateCity(updateInfo, cityId).then(ui.updateCitySuccess(cityId)).catch(ui.updateCityFailure);
	};

	var showMap = function showMap(event) {
	  event.preventDefault();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var updateCity = function updateCity(data, id) {
	  return $.ajax({
	    url: config.apiOrigin + '/cities/' + id,
	    method: 'PATCH',
	    headers: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var showCitiesTemplate = __webpack_require__(16);

	var createCitySuccess = function createCitySuccess(data) {
	  $('#addCity-modal').modal('hide');
	  $('.user-city-message').text("City added. Click 'View Cities' for updated list");
	};

	var createCityFailure = function createCityFailure() {
	  // console.log('create city failure. error is:', error)
	};

	var deleteCitySuccess = function deleteCitySuccess(id) {
	  event.preventDefault();
	...
	var deleteCityFailure = function deleteCityFailure() {
	  // console.log('delete city failure.')
	};

	var getCitiesSuccess = function getCitiesSuccess(data) {
	  // console.log(data)
	  var showCitiesHtml = showCitiesTemplate({ cities: data.cities });
	  $('.content').html(showCitiesHtml);
	  $('#removeBtn').on('click', deleteCitySuccess);
	  $('.user-city-message').empty();
	};

	var getCitiesFailure = function getCitiesFailure() {
	  // console.log('get cities failure. error is:', error)
	};

	var updateCitySuccess = function updateCitySuccess() {
	  $('.city-form-update').text("Successfully updated. Close window and click 'View Cities' to see updates");
	};

	var updateCityFailure = function updateCityFailure() {
	  // $('.update-modal-label').text("'City' field cannot be blank")
	  // console.log('update city failure. error is:', error)
	};

	module.exports = {
	  createCitySuccess: createCitySuccess,
	  createCityFailure: createCityFailure,
	  deleteCitySuccess: deleteCitySuccess,
	  deleteCityFailure: deleteCityFailure,
	  getCitiesSuccess: getCitiesSuccess,
	  getCitiesFailure: getCitiesFailure,
	  updateCitySuccess: updateCitySuccess,
	  updateCityFailure: updateCityFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <div data-id=\""
	    ...
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.state : stack1), depth0))
	    + " &nbsp&nbsp&nbsp&nbsp Country: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.country : stack1), depth0))
	    + " &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp\n    <button class=\"updateBtn\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" data-toggle=\"modal\" data-target=\"#updateCity-modal"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Update</button>\n    <button class=\"removeBtn\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Remove</button>\n    </p>\n  </div>\n\n  <div class=\"modal fade\" id=\"updateCity-modal"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"update-city-modal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\">\n    <div class=\"modal-dialog\" role=\"document\">\n      <div class=\"modal-content\">\n        <div class=\"modal-header\">\n          <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n          <h4 class=\"modal-title\" class=\"update-modal-label\">Update</h4>\n        </div>\n        <div class=\"modal-body\">\n          <form class=\"city-form-update\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n            <div class=\"form-group\">\n              <input type=\"text\" name=\"city[name]\" id=\"city-update\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "\" placeholder=\"City (required)\" required>\n              <input type=\"text\" name=\"city[state]\" id=\"state-update\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.state : stack1), depth0))
	    + "\" placeholder=\"State\">\n              <input type=\"text\" name=\"city[country]\" id=\"country-update\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.country : stack1), depth0))
	    + "\" placeholder=\"Country\">\n              <input type=\"submit\" name=\"submit\" value=\"Update info\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"submit-update-button\">\n            </div>\n          </form>\n        </div>\n      </div>\n    </div>\n  </div>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.cities : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
